...
//     Then they must mail the required documents to "abc@gmail.com" for verification. 
//     Once the recruiter is verified, they can post jobs which job seekers can apply to.`,
//   },
//   {
...
//   return (
//     <div>
//       <Navbar />   {/* Here is your Navbar like in Browse.jsx */}

//       <div className="max-w-4xl mx-auto p-6 mt-12 mb-24 bg-white rounded-lg shadow-md">
